...
├── CLAUDE.md       # Hướng dẫn kiến trúc & quy ước code
└── TECHSHOP_PROJECT_BRIEF.md  # Đặc tả dự án đầy đủ
```
...
- [TECHSHOP_PROJECT_BRIEF.md](TECHSHOP_PROJECT_BRIEF.md) — Đặc tả dự án đầy đủ
- [CLAUDE.md](CLAUDE.md) — Kiến trúc, tech stack, quy ước code & database
- [QUY_TRINH_VA_TROUBLESHOOTING.md](QUY_TRINH_VA_TROUBLESHOOTING.md) — Quy trình & xử lý sự cố
